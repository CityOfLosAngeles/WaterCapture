...
incidental_SFV_total <- (total_rainfall_LA/18.73) * incidental_avg_LA

incidental_LA_today <- (today_rainfall_LA/18.73) * incidental_avg_LA
incidental_SFV_today <- (today_rainfall_LA/18.73) * incidental_avg_LA
...
test <- data.frame(now(), spreading_capture, barrels_and_cisterns_capture, barrels_and_cisterns_today, incidental_capture,	incidental_today, GI_capture, GI_today)
names(test) <- c("Timestamp", "spreading_capture", "barrels_and_cisterns_capture", "barrels_and_cisterns_today", "incidental_capture",	"incidental_today", "GI_capture", "GI_today")
glimpse(test)

names(total_capture) <- c("Timestamp", "spreading_capture", "barrels_and_cisterns_capture", "barrels_and_cisterns_today", "incidental_capture",	"incidental_today", "GI_capture", "GI_today")
glimpse(test2)

test2 <- rbind(total_capture, test)
