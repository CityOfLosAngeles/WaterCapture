...
Spreading Ground capture this season = `r rowSums(this_season)` acre feet.
...
Green Infrastructure Capture this season = `r incidental_capture` acre feet.
Green Infrastructure Capture today = `r incidental_today` acre feet.
